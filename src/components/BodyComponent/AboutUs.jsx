          ...
          <Grid container direction='row' spacing={2}>
            ...
            <Grid item sm={12} md={7}>
              {RenderSectionHeading({
                SmallText: "ABOUT US",
                Title: "Hello I'm vikash pathak CEO of this company",
                Description:
                  "i have group of developer who loves to codes something that wiil impact  majority of the people in good waay !",
              })}
              <br />
